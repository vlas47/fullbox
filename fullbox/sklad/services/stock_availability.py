...
def inventory_items_for_agency(
    ...
    stock_rows = snapshot_stock_rows(agency=agency)
    ...
    if exclude_processing_order_id is None and exclude_shipping_order_id is None and use_materialized_availability:
        ...
        shipping_reserve_map, shipping_reserve_any = build_shipping_reserve_maps(
            agency,
...
def occupied_os_cell_keys(
    ...
    rows = list(rows) + _occupied_os_operation_rows(exclude_pallet_code=exclude_pallet_code)
