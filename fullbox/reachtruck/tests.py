...
class ReachtruckMobileFlowTests(TestCase):
    ...
    def test_mobile_category_shows_continue_current_request_after_take_request(self):
        ...
        self.assertContains(response, 'ime-mode: disabled;')
        self.assertContains(response, 'const scanCodeCharMap = {')
        self.assertContains(response, 'const handleScanKeydown = (event) => {')
